...
namespace AspNetCoreEfTest
{
    public class Startup
    {
        ...
        {
            return "Server=localhost;Database=AspNetCoreEfTest;Integrated Security=true";
        }
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            ob.UseSqlServer("Server=localhost;Database=AspNetCoreEfTest;Integrated Security=true");
